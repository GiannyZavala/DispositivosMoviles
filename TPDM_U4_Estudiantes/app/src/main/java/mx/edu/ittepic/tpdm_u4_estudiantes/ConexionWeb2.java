...
public class ConexionWeb2 extends AsyncTask<URL,String,String> {

    List<String[]> variables;
    MainActivity puntero;
    ProgressDialog dialogo;

    public ConexionWeb2(MainActivity p){
        puntero=p;
    ...
    protected void onPostExecute(String resp){
        ...
        String[] estudiantes= resp.split("<br />");
        String concatenacion= "";

        for(int i=0; i<estudiantes.length;i++){
            String[] datos= estudiantes[i].split(",");
            concatenacion+="Nombre: "+datos[0]+"\n"+"Domicilio: " +datos[1] +"\n"+"Carrera: "+datos[2]+"\n"+"Promedio: "+datos[3]+"\n-----\n";
        }
            puntero.resultado.setText(concatenacion);
    }
}
